...
const unFollowUser = async (req, res) => {
    try {
     ...
     const isFollowingIndex = user.following.findIndex(
         ...
         if(isFollowingIndex === -1) return res.status(401).send("User not followed before");
...
module.exports = {getProfile, getUserPosts, getFollowers, followUser, unFollowUser, getFollowing}